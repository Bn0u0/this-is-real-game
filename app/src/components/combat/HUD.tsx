...
/**
 * HUD Component
 * Defines the visual overlay for the combat interface.
 * Contains: Stats, Time, Logic specific to UI interactions.
 * 
 * IMPORTANT: The root element is pointer-events-none to allow clicks 
 * to pass through to the Joystick layer below.
...
export const HUD: React.FC = () => {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none p-4 flex flex-col justify-between overflow-hidden font-mono select-none z-10">
            {/* z-10 ensures HUD is above Joystick (z-0) */}
            ...
            {showClassSelection && (
                <div className="absolute inset-0 bg-black/95 flex flex-col items-center justify-center pointer-events-auto z-[300]">
                    ...
                    <div className="flex gap-4 md:gap-8 flex-wrap justify-center pointer-events-auto">
                        {/* MELEE */}
                ...
                <div className="absolute inset-0 bg-black/95 flex flex-col items-center justify-center pointer-events-auto z-[300]">
                    ...
                    <div className="flex gap-8 pointer-events-auto">
                        ...
                        <button
                            ...
                            className="px-12 py-4 bg-amber-600 text-black font-bold hover:bg-amber-400 transition-all shadow-[0_0_20px_rgba(245,158,11,0.3)] hover:shadow-[0_0_40px_rgba(245,158,11,0.6)] flex flex-col items-center gap-1 group overflow-hidden"
                        >
