        ...
        <div className="w-full h-full p-4 md:p-8 flex flex-col gap-4">
            ...
            <div className="flex justify-between items-center text-[#00FFFF] tracking-widest text-sm uppercase">
                ...
                <div className="flex gap-4">
                    ...
                    <span className="text-[#FFD700]">{profile.credits} CR</span>
                </div>
            </div>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 min-h-0">
                ...
                <TechPanel title="OPERATOR STATUS" className="flex flex-col gap-6">
                ...
                <TechPanel title="ARMORY" className="overflow-y-auto">
